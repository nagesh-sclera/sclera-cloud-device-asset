# CLAUDE.md — sclera-inspection

## Project identity
Walking-skeleton microservice scaffolded by `tools/skeleton-template/scaffold-skeleton.sh`. Spring Boot 2.6.5, Java 17. Hosts the future real `sclera-inspection` service's Dapr surface.
