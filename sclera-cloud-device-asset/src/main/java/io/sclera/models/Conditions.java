...
// @NamedNativeQueries pruned 2026-06-11: all converted queries removed; only still-native ones kept.
// addCondition — stays native (INSERT with 43 positional params; no JPQL INSERT syntax).
// getConditionsForAdvanceExcelExport — stays native (multi-table join returning Map projection).
@NamedNativeQueries({
