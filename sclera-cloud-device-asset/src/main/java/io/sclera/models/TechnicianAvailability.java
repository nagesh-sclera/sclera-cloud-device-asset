...
@NamedNativeQueries({
    ...
    // CONVERTED — TechnicianAvailability.getTechnicianAvailabilityById native query removed; now JPQL findEntityById + MapStruct (TechnicianAvailabilityDtoMapper). @SqlResultSetMapping kept: still used by getAllTechnicianAvailability and getTechnicianAvailabilityInRange.
