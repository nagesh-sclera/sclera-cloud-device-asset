...
@SqlResultSetMapping(name = "clientNfcDetails", classes = {@ConstructorResult(targetClass = ClientNfcDTO.class, columns = {
...
@NamedNativeQuery(name = "ClientNfc.getClientNfcDetailsByVdmsIdAndDeviceId",
    query = "SELECT id, nfc_id, uuid, location_id, device_id, creation_time, created_by, vdms_id FROM client_nfc WHERE vdms_id = ?1 AND device_id = ?2",
    resultSetMapping = "clientNfcDetails")
/**
