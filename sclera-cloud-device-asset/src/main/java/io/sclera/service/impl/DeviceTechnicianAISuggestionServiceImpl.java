...
public class DeviceTechnicianAISuggestionServiceImpl implements DeviceTechnicianAISuggestionService {
    private static final Logger log = LoggerFactory.getLogger(DeviceTechnicianAISuggestionServiceImpl.class);
    ...
    @Autowired
    public DeviceTechnicianAISuggestionServiceImpl(DeviceTechnicianAISuggestionRepository deviceTechnicianAiSuggestionRepository, TechnicianService technicianService) {
