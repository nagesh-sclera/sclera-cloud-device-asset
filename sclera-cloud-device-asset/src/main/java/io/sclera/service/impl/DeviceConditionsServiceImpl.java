 ...
 */
@Service
public class DeviceConditionsServiceImpl implements DeviceConditionsService {
    private static final Logger log = LoggerFactory.getLogger(DeviceConditionsServiceImpl.class);
