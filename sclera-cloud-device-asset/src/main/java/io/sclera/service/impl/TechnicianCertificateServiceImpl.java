...
import io.sclera.service.TechnicianCertificateService;
 ...
 */
@Service
public class TechnicianCertificateServiceImpl implements TechnicianCertificateService {
    private static final Logger log = LoggerFactory.getLogger(TechnicianCertificateServiceImpl.class);

    private final TechnicianCertificateRepository technicianCertificateRepository;

    @Autowired
    public TechnicianCertificateServiceImpl(TechnicianCertificateRepository technicianCertificateRepository) {
