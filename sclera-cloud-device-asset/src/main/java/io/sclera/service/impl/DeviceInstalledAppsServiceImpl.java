 ...
 */
@Service
public class DeviceInstalledAppsServiceImpl implements DeviceInstalledAppsService {

    private final DeviceInstalledAppsRepository deviceInstalledAppsRepository;

    public DeviceInstalledAppsServiceImpl(DeviceInstalledAppsRepository deviceInstalledAppsRepository) {
