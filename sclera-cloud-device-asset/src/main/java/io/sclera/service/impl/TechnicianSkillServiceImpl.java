...
import io.sclera.service.TechnicianSkillService;
...
public class TechnicianSkillServiceImpl implements TechnicianSkillService {
    private static final Logger log = LoggerFactory.getLogger(TechnicianSkillServiceImpl.class);

    private final TechnicianSkillRepository technicianSkillRepository;

    @Autowired
    public TechnicianSkillServiceImpl(TechnicianSkillRepository technicianSkillRepository) {
