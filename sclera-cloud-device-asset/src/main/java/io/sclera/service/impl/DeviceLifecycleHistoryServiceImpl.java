 ...
 */
@Service
public class DeviceLifecycleHistoryServiceImpl implements DeviceLifecycleHistoryService {

    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DeviceLifecycleHistoryServiceImpl.class);
