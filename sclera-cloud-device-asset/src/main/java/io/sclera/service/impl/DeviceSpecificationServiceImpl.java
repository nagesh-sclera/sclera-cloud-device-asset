...
public class DeviceSpecificationServiceImpl implements DeviceSpecificationService {
    private static final Logger log = LoggerFactory.getLogger(DeviceSpecificationServiceImpl.class);
    ...
    public DeviceSpecificationServiceImpl(DeviceSpecificationRepository deviceSpecificationRepository, DeviceInstalledAppsRepository deviceInstalledAppsRepository,
