 ...
 */
@Service
public class ManagedSoftwareSearchServiceImpl implements ManagedSoftwareSearchService {
    private static final Logger log = LoggerFactory.getLogger(ManagedSoftwareSearchServiceImpl.class);
