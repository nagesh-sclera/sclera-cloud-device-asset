...
import io.sclera.service.DeviceTypeService;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    private static final Logger log = LoggerFactory.getLogger(DeviceTypeServiceImpl.class);
    ...
    public DeviceTypeServiceImpl(DeviceTypesRepository deviceTypesRepository) {
