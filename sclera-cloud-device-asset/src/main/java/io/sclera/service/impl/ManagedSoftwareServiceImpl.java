 ...
 */
@Service
public class ManagedSoftwareServiceImpl implements ManagedSoftwareService {
    private static final Logger log = LoggerFactory.getLogger(ManagedSoftwareServiceImpl.class);
    ...
    public ManagedSoftwareServiceImpl(ManagedSoftwareRepository managedSoftwareRepository,
                                  DeviceInstalledAppsService deviceInstalledAppsService,
                                  DeviceInstalledAppsRepository deviceInstalledAppsRepository,
                                  DeviceSpecificationRepository deviceSpecificationRepository,
                                  ApplicationUserRepository applicationUserRepository,
