...
public class ClientNfcService {
    ...
    // =========================================================================
    // Read/enrichment (local; formerly served by sclera-integrations via ClientNfcClient).
    // Mirrors ClientQrCodeService.
    // =========================================================================

    public Integer getClientNfcCountByDeviceId(String deviceId) {
        log.info("getClientNfcCountByDeviceId");
        return clientNfcRepository.getClientNfcCountByDeviceId(deviceId);
    }

    public JSONArray getDeviceIdsTaggedToClientNfc(String vdmsId) {
        log.info("getDeviceIdsTaggedToClientNfc");
        return clientNfcRepository.getDeviceIdsTaggedToClientNfc(vdmsId);
    }

    public JSONArray getLocationIdsTaggedToClientNfc(String vdmsId) {
        log.info("getLocationIdsTaggedToClientNfc");
        return clientNfcRepository.getLocationIdsTaggedToClientNfc(vdmsId);
    }
}
