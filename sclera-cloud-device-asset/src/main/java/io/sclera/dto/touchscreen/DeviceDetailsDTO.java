...
public class DeviceDetailsDTO {
	...
	public DeviceDetailsDTO(String id, String alarm, String display_name, String product_id, String ip_address,
							String mac_address, String last_seen_on, String model, Integer status, String type, String user_data_model,
							String user_data_name, String user_data_vendor, String vendor, String local_vendor_id,
							String other_vendor_1_id, String other_vendor_2_id, String other_vendor_3_id, String docker_name, String building, String floor,
							String location, String image_url_1, String image_url_2, String image_url_3, Integer virtual_device_type,
							...
							String record_checklist_status, String daintree_status, String ecobee_status, String modbus_status,String asset_group) {
		super();
		this.id = id;
		this.alarm = alarm;
		this.display_name = display_name;
