$path = 'C:\Users\DhanushVasanth\Desktop\AssetManagement POD\Microservice\sclera-cloud-device-asset\src\main\java\io\sclera\models\Phonebook.java'
$content = @"
...
if ($bytes[0] -eq 0xEF) { Write-Error 'BOM!' } else { Write-Host 'Phonebook.java written OK' }
