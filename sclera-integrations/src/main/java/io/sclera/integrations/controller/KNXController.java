...
public class KNXController {
  ...
  @GetMapping("/listKNXDevicesAlertMessagesByDeviceIds")
  public List<String> listKNXDevicesAlertMessagesByDeviceIds(@RequestParam String ids) {
    return Defaults.emptyList();
  }

  @GetMapping("/updateKnxGroupDeviceId")
  public void updateKnxGroupDeviceId(@RequestParam String oldId, @RequestParam String newId, @RequestParam String ids) {
    // no-op
  }
}
