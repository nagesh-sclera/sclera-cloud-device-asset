...
public class MonnitController {
  ...
  @GetMapping("/listmonnitDevicesAlertMessagesByDeviceIds")
  public List<String> listmonnitDevicesAlertMessagesByDeviceIds(@RequestParam String ids) {
    return Defaults.emptyList();
  }

  @GetMapping("/updateMonnitSensorDeviceId")
  public void updateMonnitSensorDeviceId(@RequestParam String oldId, @RequestParam String newId, @RequestParam String ids) {
    // no-op
  }
}
